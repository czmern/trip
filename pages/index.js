...
const ALL_AIRPORTS=[
  ...
  {code:'NCE',name:'Nice Côte d\'Azur',country:'🇫🇷 Fransa'},
  {code:'LYS',name:'Lyon Saint-Exupéry',country:'🇫🇷 Fransa'},
  ...
  {code:'ORD',name:'Chicago O\'Hare',country:'🇺🇸 ABD'},
  ...
  async function go(){
    ...
    try{
      ...
      const [wR,cR,coR]=await Promise.allSettled([
        ...
        fetch(`/api/currency?base=EUR&targets=IDR,TRY,USD,CHF,GBP,JPY,THB,AED,MAD,EGP`).then(r=>r.json()),
      ...
      <div style={{background:'var(--paper)'}}>
        <div className="results">
          ...
          <div className="sec">
            ...
            <div className="rg">
              {rental==='car'&&[
                {icon:'🚙',name:'Ekonomi Sedan',spec:'Otomatik · 5 kişilik · A/C',price:'€12–18',feats:res.form.hasPet?['🐾 Evcil hayvan OK','Sigorta']:['Sigorta dahil','GPS']},
                {icon:'🚗',name:'SUV / Crossover',spec:'Otomatik · 5 kişilik · Geniş',price:'€22–35',feats:res.form.hasPet?['🐾 Evcil hayvan OK','GPS']:['GPS','USB','Geniş bagaj']},
                {icon:'🚐',name:'Minibüs + Şoför',spec:'7–12 kişilik · Şoförlü',price:'€45–80',feats:res.form.hasPet?['🐾 Evcil hayvan OK','Şoförlü']:['İngilizce şoför','Esnek güzergah']},
